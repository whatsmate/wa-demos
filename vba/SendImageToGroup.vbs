Sub Main_Routine()
  ...
  WhatsAppImage_SendtoGroup "Happy Club Group", "C:\Users\Public\cute-girl.jpg", "Lovely Girl"      ''' TODO: Specify the name of the group
End Sub


Sub WhatsAppImage_SendtoGroup(ByRef strGroupName As String, ByRef strFilename As String, ByRef strCaption As String)
